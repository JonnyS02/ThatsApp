...
This project runs PHPUnit 13.1 with PHP 8.5. Support for this has been built
into the **composer.json** file and can easily be installed via Composer 2.9 if
you don't already have it installed globally.
